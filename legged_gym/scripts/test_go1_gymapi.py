...
# load ball asset
asset_root = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),  "resources/robots/go2")
asset_file = "urdf/go2_collision_show.urdf"
...
actor_handle = gym.create_actor(env_handle, robot_asset, start_pose, 'legged_robot', 0, 1, 0)
...
feet_pos = rigid_body_state.view(1, 17, 13)[:,feet_indices,0:3]
feet_vel = rigid_body_state.view(1, 17, 13)[:,feet_indices,7:10]
